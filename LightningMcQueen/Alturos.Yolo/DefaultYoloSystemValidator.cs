    ...
    public class DefaultYoloSystemValidator : IYoloSystemValidator
    {
        ...
        private bool IsMicrosoftVisualCPlusPlus2017Available()
        {
            ...
            var checkKeys = new Dictionary<string, string>
            {
                ...
                { @"Installer\Dependencies\VC,redist.x64,amd64,14.20,bundle", "Microsoft Visual C++ 2015-2022 Redistributable (x64)" },
                { @"Installer\Dependencies\VC,redist.x64,amd64,14.21,bundle", "Microsoft Visual C++ 2015-2022 Redistributable (x64)" },
                { @"Installer\Dependencies\VC,redist.x64,amd64,14.22,bundle", "Microsoft Visual C++ 2015-2022 Redistributable (x64)" },
                { @"Installer\Dependencies\VC,redist.x64,amd64,14.23,bundle", "Microsoft Visual C++ 2015-2022 Redistributable (x64)" },
                { @"Installer\Dependencies\VC,redist.x64,amd64,14.24,bundle", "Microsoft Visual C++ 2015-2022 Redistributable (x64)" },
                { @"Installer\Dependencies\VC,redist.x64,amd64,14.25,bundle", "Microsoft Visual C++ 2015-2022 Redistributable (x64)" },
                { @"Installer\Dependencies\VC,redist.x64,amd64,14.38,bundle", "Microsoft Visual C++ 2015-2022 Redistributable (x64)" }
            };
